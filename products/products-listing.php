            ...
            <article class="dokan-product-listing-area">
                ...
                <div class="product-listing-top dokan-clearfix">
                    ...
                    <?php if ( dokan_is_seller_enabled( get_current_user_id() ) ): ?>
                        <span class="dokan-add-product-link" style="width: auto;">

                            <!-- Update Products button -->
                            <a href="<?php echo home_url().'/index.php/dashboard/update-products/'?>" class="dokan-btn dokan-btn-theme">
                                <i class="fa fa-briefcase">&nbsp;</i>
                                <?php _e( 'Update Products', 'dokan-lite' ); ?>
                            </a>

                            <!-- Import Products button -->
                            <a href="<?php echo home_url().'/index.php/dashboard/import-products/'?>" class="dokan-btn dokan-btn-theme">
                                <i class="fa fa-briefcase">&nbsp;</i>
                                <?php _e( 'Import Products', 'dokan-lite' ); ?>
                            </a>

                            <?php if ( current_user_can( 'dokan_add_product' ) ): ?>
                                <!-- href="<?php echo dokan_get_navigation_url( 'new-product' ); ?>" -->
                                <a href="#" onclick="return false;" class="ck_add_new_product dokan-btn dokan-btn-theme <?php echo ( 'on' == dokan_get_option( 'disable_product_popup', 'dokan_selling', 'off' ) ) ? '' : 'dokan-add-new-product'; ?>">
                                    <i class="fa fa-briefcase">&nbsp;</i>
                            ...
                            <?php
                                // Remove Import & Export buttons for now
                        ...
                        <tbody>
                            ...
                            if ( $product_query->have_posts() ) {
                                while ($product_query->have_posts()) {
                                    ...
                                    <?php 
                                    // check valid product
                                    $ck_valid_product = get_post_meta($post->ID, '_ck_valid_product', true);
                                    if( $ck_valid_product == '' ){?>
