    ...
    <div class="dokan-dashboard-content dokan-product-edit">
        ...
        <div class="product-edit-new-container product-edit-container">
            ...
            <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                <!-- Success Modal -->
                <div id="success_addproduct_myModal" class="modal fade" role="dialog">
                ...
                <script type="text/javascript">
                    jQuery(document).ready(function(){
                        jQuery("#success_addproduct_myModal").modal("show");
                        setTimeout(function () {
                            var baseUrl = document.location.origin; 
                            window.location.href = baseUrl+"/index.php/dashboard/products/";
                        }, 2000);
                    });
                </script>
                <!-- hold for now -->
            ...
            if ( $can_sell ) {
                ...
                if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                    <form class="dokan-product-edit-form" role="form" method="post" autocomplete="off">
                            ...
                            <div class="content-half-part dokan-product-meta">
                                ...
                                <div class="show_if_simple dokan-clearfix">
                                    ...
                                    <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                        ...
                                        <div class="content-full-part regular-price">
                                        ...
                                        <!-- hide for now -->
                                        <div class="content-half-part sale-price" style="display: none;">
                                ...
                                <div class="dokan-form-group">
                                    <label for="product_tag" class="form-label"><?php _e( 'Tags', 'dokan-lite' ); ?></label>
                                    <select class="js-example-basic-multiple" name="custom_product_tag[]" id="custom_product_tag" multiple="multiple">
                                        <?php
                                        $args = array(
                                            'number'     => $number,
                                            'orderby'    => $orderby,
                                        ...
                                        $selected_terms = get_the_terms($post_id,"product_tag");
                                        ...
                                        $terms = get_terms( 'product_tag', $args ); 
                                            if ( $terms && ! is_wp_error( $terms ) ) {
                                                foreach ( $terms as $term ) {
                                                    if (in_array($term->name, $term_links)) {
                                                        $selected = 'selected';
                                                    }else{
                                                        $selected = '';
                                                    }
                                ...
                                <!-- Product Brand field -->
                                <?php $product_brand = get_post_meta($post_id, '_product_brand', true); ?>
                                <div class="dokan-form-group">
                                    <label for="" class="form-label"><?php _e( 'Brand', 'dokan-lite' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, 'product_brand', array( 'placeholder' => __( 'Brand..', 'dokan-lite' ), 'value' => $product_brand ) ); ?>
                                </div>

                                <!-- Product Manufacturer field -->
                                <?php $product_manufacture = get_post_meta($post_id, '_product_manufacture', true); ?>
                                <div class="dokan-form-group">
                                    <label for="" class="form-label"><?php _e( 'Manufacturer', 'dokan-lite' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, 'product_manufacture', array( 'placeholder' => __( 'Manufacturer..', 'dokan-lite' ), 'value' => $product_manufacture ) ); ?>
                                </div>

                                <!-- Product Model field -->
                                <?php $product_model = get_post_meta($post_id, '_product_model', true); ?>
                                <div class="dokan-form-group">
                                    <label for="" class="form-label"><?php _e( 'Model', 'dokan-lite' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, 'product_model', array( 'placeholder' => __( 'Model..', 'dokan-lite' ), 'value' => $product_model ) ); ?>

                                    <div class="content-half-part dokan-form-group" style="padding-top: 15px;">
                                        <?php $product_UPC = get_post_meta($post_id, '_product_UPC', true); ?>
                                        <label for="" class="form-label"><?php _e( 'UPC', 'dokan-lite' ); ?></label>
                                        <?php dokan_post_input_box( $post_id, 'product_UPC', array( 'placeholder' => __( 'UPC..', 'dokan-lite' ), 'value' => $product_UPC ) ); ?>
                                    </div>

                                    <div class="content-half-part dokan-form-group" style="padding-top: 15px;">
                                        <?php $product_EAN = get_post_meta($post_id, '_product_EAN', true); ?>
                                        <label for="" class="form-label"><?php _e( 'EAN', 'dokan-lite' ); ?></label>
                                        <?php dokan_post_input_box( $post_id, 'product_EAN', array( 'placeholder' => __( 'EAN..', 'dokan-lite' ), 'value' => $product_EAN ) ); ?>
                                    </div>
                        ...
                        <div class="dokan-product-short-description">
                            <label for="post_excerpt" class="form-label"><?php _e( 'Features', 'dokan-lite' ); ?></label>
