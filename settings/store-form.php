...
<?php
    ...
    // new fields
    $setting_cancelation_rate          = isset( $profile_info['setting_cancelation_rate'] ) ? esc_attr( $profile_info['setting_cancelation_rate'] ) : '';
    $setting_returns_rate          = isset( $profile_info['setting_returns_rate'] ) ? esc_attr( $profile_info['setting_returns_rate'] ) : '';
    $setting_ship_on_time          = isset( $profile_info['setting_ship_on_time'] ) ? esc_attr( $profile_info['setting_ship_on_time'] ) : '';
    $setting_custom_support_response_time          = isset( $profile_info['setting_custom_support_response_time'] ) ? esc_attr( $profile_info['setting_custom_support_response_time'] ) : '';
...
<?php do_action( 'dokan_settings_before_form', $current_user, $profile_info ); ?>
    ...
    <form method="post" id="store-form"  action="" class="dokan-form-horizontal">
        ...
        <!-- new fields -->
            <!-- Cancelation rate -->
            <!-- <div class="dokan-form-group">
                <label class="dokan-w3 dokan-control-label"><?php _e( 'Cancelation rate', 'dokan-lite' ); ?></label>
                <div class="dokan-w5 dokan-text-left">
                    <input type="number" name="setting_cancelation_rate" value="<?php echo $setting_cancelation_rate; ?>" placeholder="0">%
                </div>
            </div> -->

            <!-- Returns rate -->
            <!-- <div class="dokan-form-group">
                <label class="dokan-w3 dokan-control-label"><?php _e( 'Returns rate', 'dokan-lite' ); ?></label>
                <div class="dokan-w5 dokan-text-left">
                    <input type="number" name="setting_returns_rate" value="<?php echo $setting_returns_rate; ?>" placeholder="2">%
                </div>
            </div> -->

            <!-- Ship on time -->
            <!-- <div class="dokan-form-group">
                <label class="dokan-w3 dokan-control-label"><?php _e( 'Ship on time', 'dokan-lite' ); ?></label>
                <div class="dokan-w5 dokan-text-left">

                    <input type="number" name="setting_ship_on_time" value="<?php echo $setting_ship_on_time; ?>" placeholder="100">%
                </div>
            </div> -->

            <!-- Customer support average response time -->
            <!-- <div class="dokan-form-group">
                <label class="dokan-w3 dokan-control-label"><?php _e( 'Customer support average response time', 'dokan-lite' ); ?></label>
                <div class="dokan-w5 dokan-text-left">
                    <select name="setting_custom_support_response_time" class="dokan-form-control">
                        <option value="Less than a day" <?php if ($setting_custom_support_response_time == 'Less than a day') {echo 'selected';}?> >Less than a day</option>
                        <option value="1-2 days" <?php if ($setting_custom_support_response_time == '1-2 days') {echo 'selected';}?> >1-2 days</option>
                        <option value="2-5 days" <?php if ($setting_custom_support_response_time == '2-5 days') {echo 'selected';}?> >2-5 days </option>
                    </select>
                </div>
            </div> -->
        <!-- new fields -->
